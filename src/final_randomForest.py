...
def get_complementary_colors(skin_tone, hair_color):
    color_palettes = {
        ...
        'neutral': ['white', 'black', 'navy', 'taupe', 'beige', 'gray', 'cream']
    }
...
def train_model():
    ...
    if X is not None and len(set(y)) > 1:
...
BODY_TYPE_RULES = {
    'hourglass': {'article_type': ['dresses', 'tops', 'jeans'], 'neck_type': ['v-neck', 'sweetheart'], 'priority': 3.0},
    'pear': {'article_type': ['skirts', 'tops', 'trousers'], 'neck_type': ['scoop', 'boatneck'], 'priority': 2.5},
    'apple': {'article_type': ['tshirts', 'track pants', 'jackets'], 'neck_type': ['v-neck', 'wrap'], 'priority': 2.0},
    'rectangle': {'article_type': ['dresses', 'jeans', 'blazers'], 'neck_type': ['off-shoulder', 'halter'], 'priority': 1.5}
}
